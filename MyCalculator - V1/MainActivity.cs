...
namespace MyCalculator
{
    ...
    public class MainActivity : Activity
    {
        ...
        public void DeleteNumber()
        {
            ...
            if(originalLength > 0 && Convert.ToInt32(original) != 0)
            {
        ...
        {
            int selectedOperator = FindSelectedOperator();

            PerformOperation(selectedOperator);

        }

        private int FindSelectedOperator()
        {
        ...
        private void PerformOperation(int selectedOperator)
        {
            string[] numbers = null;
            switch (selectedOperator)
            {
                case 1:
                    numbers = GetNumbers(selectedOperator);
                    AddNumbers(numbers);
                    break;
                case 2:
                    numbers = GetNumbers(selectedOperator);
        ...
        private void DivideNumbers(string[] numbers)
        {
        ...
        private void MultiplyNumbers(string[] numbers)
        {
            int num1 = Convert.ToInt32(numbers[0]);
            int num2 = Convert.ToInt32(numbers[1]);
            Result.Text = Convert.ToString(num1 * num2);
        ...
        private void SubtractNumbers(string[] numbers)
        {
            int num1 = Convert.ToInt32(numbers[0]);
            int num2 = Convert.ToInt32(numbers[1]);
            Result.Text = Convert.ToString(num1 - num2);
        ...
        public string[] GetNumbers(int selectedOperator)
        {
            string operandText = Result.Text;
            string[] operands = null;
            if (selectedOperator == 1)
            {
                operands = operandText.Split('+');
            }
